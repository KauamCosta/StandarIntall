...
namespace InstallStandard {
    public partial class AVdown : Form {
        ...
        private void AVdown_Load(object sender, EventArgs e) {
            ...
            web.DownloadFileAsync(new Uri("http://srvantivirus.pinhais.pr.gov.br:8060/dlpkg?id=18195688"), @"C:/Temp/StandarInstall/AV/kaspersky.exe");
        }

        private void Web_DownloadFileCompleted(object sender, AsyncCompletedEventArgs e) {
            lblDown.Text = "Completed";
            lblAVaux.Text = ("Abrindo porfavor espere");
            System.Diagnostics.Process.Start(@"C:/Temp/StandarInstall/AV/kaspersky.exe");
        }
